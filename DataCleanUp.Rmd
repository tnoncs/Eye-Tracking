...
Order1$SearchType=c("Count","Count","Count","Count","Count","Search","Search","Search","Search","Search")
Order2<- read_tsv('ForagingOrder2.txt',col_names = F)
Order2$Trial=1:10
Order2$SearchOrder=2
Order2$SearchType=c("Search","Search","Search","Search","Search","Count","Count","Count","Count","Count")
...
img <- jpeg::readJPEG('EyeTrackingScripts/foraging/ng021ws.jpg')
